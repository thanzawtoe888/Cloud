...
# Draw the baseline on copies of the original images
img1_with_baseline = img1.copy()
...
# SIFT is generally robust but patented in some contexts. ORB is a good free alternative.
...
axes[0].set_title('Image 1 with Baseline (frame_0000.jpg)')
axes[0].axis('off')
